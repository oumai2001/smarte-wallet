...
<div class="content">
    ...
    <form method="POST" action="<?= BASE_URL ?>income/edit/<?= $income['id'] ?>" style="background: var(--bg-main); padding: 2rem; border-radius: var(--radius); max-width: 600px;">
        ...
        <div class="form-group">
            <label>Date</label>
            <input type="date" name="date" value="<?= $income['income_date'] ?>" required>
        </div>
        ...
        <div style="display: flex; gap: 1rem;">
            ...
            <a href="<?= BASE_URL ?>income" class="btn">
